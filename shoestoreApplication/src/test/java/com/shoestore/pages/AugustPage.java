...
public class AugustPage extends BasePage {
    ...
    @FindBy(xpath = "//h2[contains(text(),'August')]")
    WebElement augustShoesPage;
    ...
    public AugustPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    public boolean verifyAugustPageDetails() {
        waitForElementToBeVisible(augustShoesPage);
        if (augustShoesPage.isDisplayed()) {
