...
public class OctoberPage extends BasePage {
    ...
    @FindBy(xpath = "//h2[contains(text(),'October')]")
    WebElement octoberShoesPage;
    ...
    public OctoberPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    public boolean verifyOctoberPageDetails() {
        waitForElementToBeVisible(octoberShoesPage);
        if (octoberShoesPage.isDisplayed()) {
