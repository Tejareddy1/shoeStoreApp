...
public class JunePage extends BasePage {
    ...
    @FindBy(xpath = "//h2[contains(text(),'June')]")
    WebElement juneShoesPage;
    ...
    public JunePage(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    public boolean verifyJunePageDetails() {
        waitForElementToBeVisible(juneShoesPage);
        if (juneShoesPage.isDisplayed()) {
