...
public class JulyPage extends BasePage {
    ...
    @FindBy(xpath = "//h2[contains(text(),'July')]")
    WebElement julyShoesPage;
    ...
    public JulyPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    public boolean verifyJulyPageDetails() {
        waitForElementToBeVisible(julyShoesPage);
        if (julyShoesPage.isDisplayed()) {
