...
public class AprilPage extends BasePage {
    ...
    @FindBy(xpath = "//h2[contains(text(),'April')]")
    WebElement aprilShoesPage;
    ...
    public AprilPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    public boolean verifyAprilPageDetails() {
        waitForElementToBeVisible(aprilShoesPage);
        if (aprilShoesPage.isDisplayed()) {
