...
public class JanuaryPage extends BasePage {
    ...
    @FindBy(xpath = "//h2[contains(text(),'January')]")
    WebElement januaryShoesPage;
    ...
    public JanuaryPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    public boolean verifyJanuaryPageDetails() {
        waitForElementToBeVisible(januaryShoesPage);
        if (januaryShoesPage.isDisplayed()) {
