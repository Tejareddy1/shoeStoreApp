...
public class DecemberPage extends BasePage {
    ...
    @FindBy(xpath = "//h2[contains(text(),'December')]")
    WebElement decemberShoesPage;
    ...
    public DecemberPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    public boolean verifyDecemberPageDetails() {
        waitForElementToBeVisible(decemberShoesPage);
        if (decemberShoesPage.isDisplayed()) {
